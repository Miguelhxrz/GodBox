...
date_default_timezone_set('America/Caracas');
  ...
  $pdf->Cell(30, 5, utf8_decode('Contraseña'), 1, 0, "C");
  $pdf->Cell(20, 5, "ID", 1, 0, "C");
  $pdf->Cell(60, 5, "Correo Electronico", 1, 0, "C");
  $pdf->Cell(60, 5, "Direccion", 1, 0, "C");
  $pdf->Cell(32, 5, "Fecha de Nacimiento", 1, 0, "C");
  ...
  while ($fila= mysqli_fetch_array($question)){
    //username`, `password`, `id`, `email`, `address`, `birth`, `fecha de registro`
    
    $pdf->Cell(30, 5, $fila['username'], 1, 0, "C");
    $pdf->Cell(30, 5, $fila['password'], 1, 0, "C");
    $pdf->Cell(20, 5, $fila['id'], 1, 0, "C");
    $pdf->Cell(60, 5, $fila['email'], 1, 0, "C");
    $pdf->Cell(60, 5, $fila['address'], 1, 0, "C");
    $pdf->Cell(32, 5, $fila['birth'], 1, 0, "C");
