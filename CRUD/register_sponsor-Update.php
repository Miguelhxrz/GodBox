    ...
    <section class="container-form">
      ...
      ?>
        <form action="" name="form-register" class="form-register" method="post" enctype="multipart/form-data">
          <input type="hidden" name="rif_input" placeholder="Rif" class="rif_input" maxlength="12" max="12" value="<?php echo $row["rif"] ?>" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
